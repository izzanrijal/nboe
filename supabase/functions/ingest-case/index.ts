...
const BodySchema = z.object({
  ...
  reading_time_minutes: z.number().min(0.5).max(15).optional(),
  time_limit_minutes: z.number().min(2).max(30).optional(),
  reading_time_seconds: z.number().int().min(30).max(900).optional(),
  time_limit_seconds: z.number().int().min(120).max(1800).optional(),
...
const SCHEMA_DOC = {
  ...
  fields: {
    ...
    reading_time_minutes: "number 0.5-15 (or reading_time_seconds 30-900)",
    time_limit_minutes: "number 2-30 (or time_limit_seconds 120-1800)",
